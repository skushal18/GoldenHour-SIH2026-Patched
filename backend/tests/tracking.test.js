...
ok('eta derived once 3 points in', () => {
  ...
  tracking.append('GH-X-0002', 12.9716, 77.5946, { lat:12.965, lng:77.5946, speed_kmh:40, at:'2026-09-10T10:00:00Z' });
  // skip throttle by clearing lastUpdateMs
  const rec = tracking.get('GH-X-0002'); rec.lastUpdateMs = 0;
  tracking.append('GH-X-0002', 12.9716, 77.5946, { lat:12.960, lng:77.5946, speed_kmh:42, at:'2026-09-10T10:00:10Z' });
  rec.lastUpdateMs = 0;
  tracking.append('GH-X-0002', 12.9716, 77.5946, { lat:12.955, lng:77.5946, speed_kmh:42, at:'2026-09-10T10:00:20Z' });
...
ok('stalled when speed < 5 for 90+s', () => {
  ...
  push(12.9710, 77.5940, '2026-09-10T10:00:00Z');
  push(12.9710, 77.5940, '2026-09-10T10:01:00Z');
  push(12.9710, 77.5940, '2026-09-10T10:01:20Z');
  push(12.9710, 77.5940, '2026-09-10T10:02:00Z');
